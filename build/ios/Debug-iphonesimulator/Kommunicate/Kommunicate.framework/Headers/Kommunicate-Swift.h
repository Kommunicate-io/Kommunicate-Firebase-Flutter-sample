...
+ (void)createConversationWithUserId:(NSString * _Nonnull)userId agentIds:(NSArray<NSString *> * _Nonnull)agentIds botIds:(NSArray<NSString *> * _Nullable)botIds useLastConversation:(BOOL)useLastConversation clientConversationId:(NSString * _Nullable)clientConversationId completion:(void (^ _Nonnull)(NSString * _Nonnull))completion SWIFT_DEPRECATED_MSG("Use createConversation(conversation:completion:)");
